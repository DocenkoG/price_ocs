...
def download( cfg ):
    ...
    try:
        ...
        driver.find_element_by_id("Content_txtUsername").send_keys("Tyf5x")
        driver.find_element_by_id("Content_txtPassword").click()
        driver.find_element_by_id("Content_txtPassword").clear()
        driver.find_element_by_id("Content_txtPassword").send_keys("Bn3kE4gBvZ")
        driver.find_element_by_id("Content_btnLogin").click()
        time.sleep(2)
        driver.get('https://b2b.ocs.ru/Reports/Transit.aspx')
        time.sleep(1)
        driver.find_element_by_id("cphBody_rblCurrency_1").click()
        time.sleep(1)
        driver.find_element_by_id("cphBody_btnDownload").click()
        time.sleep(3)
        driver.quit()
